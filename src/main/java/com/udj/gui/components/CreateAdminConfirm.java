...
public class CreateAdminConfirm extends javax.swing.JDialog {
    
    private static final java.util.logging.Logger logger = java.util.logging.Logger.getLogger(CreateAdminConfirm.class.getName());
    private boolean confirmed = false;
    
    public CreateAdminConfirm(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        CABG = new com.udj.gui.components.ButtonLabelBG();
        ...
        CABG.setIcon(new javax.swing.ImageIcon(getClass().getResource("/images/CreateAdmin.png"))); // NOI18N
        getContentPane().add(CABG, new org.netbeans.lib.awtextra.AbsoluteConstraints(0, 0, -1, -1));
    ...
    private javax.swing.JLabel CABG;
